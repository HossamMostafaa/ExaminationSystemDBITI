...
INSERT INTO [user](username,[password],role)
VALUES ('ali','123','admin')


INSERT INTO [user](username,[password],role)
VALUES ('adem','123','instructor')


INSERT INTO [user](username,[password],role)
VALUES ('hala','123','student')

select * from student_results_view
select * from student_exams_view
